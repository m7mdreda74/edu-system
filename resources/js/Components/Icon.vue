...
// A library of premium Heroicons/Lucide styled SVG paths
const paths = {
    dashboard: `
    ...
    `,
    sun: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.364l-.707-.707M12 7a5 5 0 100 10 5 5 0 000-10z" />
    `,
    moon: `
    ...
    `,
    teacher: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 4a2 2 0 012 2v6a2 2 0 01-2 2h-2v-4a2 2 0 00-2-2h-3" />
    `,
    arrowLeft: `
    ...
    `,
    atom: `
        <ellipse cx="12" cy="12" rx="3" ry="9" transform="rotate(45 12 12)" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
        <ellipse cx="12" cy="12" rx="3" ry="9" transform="rotate(-45 12 12)" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
        <ellipse cx="12" cy="12" rx="9" ry="3" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
    ...
    `,
    language: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138A14.37 14.37 0 009 15m0-12a14.37 14.37 0 01-3.334 9.636" />
    `,
    flask: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
    `,
    dna: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-9 0h9" />
    `,
    landmark: `
    ...
    `,
    attachment: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l4.5-4.5a3 3 0 114.243 4.243l-4.5 4.5a1.5 1.5 0 11-2.122-2.122l4.5-4.5" />
    `,
    emoji: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M12 21a9 9 0 110-18 9 9 0 010 18zM9 10.5h.01M15 10.5h.01" />
    `,
    file: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2zM12 3v6h6" />
    `,
    expand: `
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 3h6m0 0v6m0-6L14 10M9 21H3m0 0v-6m0 6l7-7" />
    `,
    download: `
