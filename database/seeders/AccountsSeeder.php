    ...
    public static function teacherDefinitions(): array
    {
        return [
            ...
            [
                ...
                'name'             => 'أ. سارة المهندي',
                'phone'            => '+97455000102',
                'headline'         => 'معلمة فيزياء وكيمياء — الشرح بالتجربة',
            ...
            [
                ...
                'name'             => 'أ. خالد آل ثاني',
                'phone'            => '+97455000103',
                'headline'         => 'معلم أحياء وعلوم — خرائط ذهنية وملخصات',
            ...
            [
                ...
                'name'             => 'أ. مريم الدوسري',
                'phone'            => '+97455000106',
                'headline'         => 'معلمة تاريخ وجغرافيا — المسار الأدبي',
                'bio'              => 'أحوّل التاريخ من تواريخ تُحفظ إلى قصة مترابطة، والجغرافيا إلى خرائط تُقرأ. متخصصة في منهج المسار الأدبي للحادي عشر والثاني عشر.',
                'years_experience' => 10,
                'is_featured'      => true,
                'commission'       => 20,
            ],
